...
class _ArticleDetailScreenState extends ConsumerState<ArticleDetailScreen> {
  ...
  Future<void> _fetchFullArticle() async {
    ...
    final url = 'https://articles.ns-platforms.com/api.php'
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (newsItem != null) {
          final safeHtml = SportsFunction()
              .sanitizeArticleHtml((newsItem['description'] ?? '').toString());

          setState(() {
            _htmlContent =  SportsFunction().fixMojibake(safeHtml);
            _fullTitle = SportsFunction().fixMojibake(newsItem['title']!.toString());
                    ...
                    builder: (context, constraints) {
                      ...
                      return FlexibleSpaceBar(
                        ...
                        titlePadding: const EdgeInsetsDirectional.only(
                            start: AppConfig.bigSpace,
                            bottom: AppConfig.bigSpace,
                            end: AppConfig.bigSpace),
                        title: Text(
                          title,
                          maxLines: 2,
